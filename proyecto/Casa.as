class Casa {
	...
	public function Casa(artefactos:Object){
		...
		// inicializamos los totales de habitaciones y elementos comunes
		for(var hab:String in this.habitaciones) {
			...
			this.handlers.calefactor_switch.onRelease = function() {
			//_root["calefactor_" + habitaciones[hab] + "_switch"].onRelease = function() {
				...
				_root[calef + "_calorias"].text = this.artefactos[calef].cambiarCalorias();
	...
	public function actualizarTotales(obj) {
