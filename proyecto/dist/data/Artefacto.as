class Artefacto {
	...
	public static function get TIPO_ELEC():Number {
		return 1;
	}
	public static function get TIPO_GAS():Number {
		return 2;
	}
	public static function get TIPO_AUTO():Number {
		return 3;
	}
	public static function get COEFICIENTE_ELEC():Number {
		return 0.0004;
	}
	public static function get COEFICIENTE_GAS():Number {
		return 0.00195;
	}
	...
	public var periodoHoras:Number;
	// en cuanto se incrementa. Por defecto 1. Cafetera: 0.25 (15 min.)
	public var consumo:Number;
	// consumo horario de gas o energia electrica (segun el tipo)
	...
	public var calorias:Number;
	// solo para calefactor
	public var watts:Number;
	// solo para lamparas electricas
	public var consumos:Object;
	// solo para alguno de los 2 anteriores
	public function Artefacto(datos:Object) {
		...
		if (datos.periodoHoras != undefined) {
			//ej. cafetera = 15 minutos = 0.25
